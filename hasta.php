...
<?php
		if($_POST){
			$tc = $_POST["tc"];
			$sifre = $_POST["sifre"];
			$bul = mysql_query("SELECT * FROM hastalar WHERE tc = '$tc' && sifre = '$sifre'");
			$say = mysql_fetch_array($bul);
				...
				if($say > 0 ){
					...
					echo "<li><a href='hastabilgi.php'>Hasta Bilgi Düzenle</a>";
					echo "<li><a href='hastaradevual.php'>Randevu Al</a>";
				...
				<center>
					<form method="POST">
						...
						<div>
						  ...
						  <input type="button" value="KAYDOL" onclick=location.href="hastakayit.php">
						</div>
					</form>
				</center>
			';
